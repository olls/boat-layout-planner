...
TEMPLATES = {
    'furniture': {
        ...
        'table': {
            ...
            'SVG': '<line fill="none" x1="{x}" y1="{y}" x2="{x}" y2="{y}+{scale}" id="svg_1" stroke="#000000"/>\
                    <line fill="none" x1="{x}+{scale}" y1="{y}" x2="{x}+{scale}" y2="{y}+{scale}" id="svg_1" stroke="#000000"/>\
                    <line fill="none" y1="{y}" x1="{x}" y2="{y}" x2="{x}+{scale}" id="svg_1" stroke="#000000"/>\
                    <line fill="none" y1="{y}+{scale}" x1="{x}" y2="{y}+{scale}" x2="{x}+{scale}" id="svg_1" stroke="#000000"/>\
                    <line fill="none" y1="{y}" x1="{x}+(0.1*{scale})" y2="{y}+(0.1*{scale})" x2="{x}+(0.1*{scale})" id="svg_1" stroke="#000000"/>\
                    <line fill="none" y1="{y}+(0.1*{scale})" x1="{x}" y2="{y}+(0.1*{scale})" x2="{x}+(0.1*{scale})" id="svg_1" stroke="#000000"/>\
                    <line fill="none" y1="{y}" x1="{x}+(0.9*{scale})" y2="{y}+(0.1*{scale})" x2="{x}+(0.9*{scale})" id="svg_1" stroke="#000000"/>\
                    <line fill="none" y1="{y}+(0.1*{scale})" x1="{x}+{scale}" y2="{y}+(0.1*{scale})" x2="{x}+(0.9*{scale})" id="svg_1" stroke="#000000"/>\
                    <line stroke="#000000" id="svg_1" x2="{x}+(0.1*{scale})" y2="{y}+(0.9*{scale})" x1="{x}+(0.1*{scale})" y1="{y}+{scale}" fill="none"/>\
                    <line stroke="#000000" id="svg_1" x2="{x}+(0.1*{scale})" y2="{y}+(0.9*{scale})" x1="{x}" y1="{y}+(0.9*{scale})" fill="none"/>\
                    <line stroke="#000000" id="svg_1" x2="{x}+(0.9*{scale})" y2="{y}+(0.9*{scale})" x1="{x}+(0.9*{scale})" y1="{y}+{scale}" fill="none"/>\
                    <line stroke="#000000" id="svg_1" x2="{x}+(0.9*{scale})" y2="{y}+(0.9*{scale})" x1="{x}+{scale}" y1="{y}+(0.9*{scale})" fill="none"/>'
        },
        'wall': {
